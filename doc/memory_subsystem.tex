...
Every polynomial-memory client port presents an identical set of signals
(Table~\ref{tab:client_if}).
...
\midrule
\texttt{poly\_mem\_tb}
  & Map/helper smoke test, protocol-store ID+beat mapping, wipe \\
\texttt{mem\_frontend\_top\_tb}
  & Full integration: legal dual-read / dual-write / read-write overlap,
    combined ownership, KeyGen placements, protocol store, wipe \\
