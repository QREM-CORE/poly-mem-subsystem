...
module mem_frontend_top_tb;
  ...
  initial begin
    ...
    $display("Scenario 0: Reset and Package Sanity Checks [STARTING]");
    $display("[DONE]");
    ...
    // ------------------------------------------------------------------
    $display("Scenario 1: PAU Primary + Aux Legal Dual-Read [STARTING]");
    pau_req               = 1'b1;
    pau_rd_en             = 1'b1;
    ...
    // ------------------------------------------------------------------
    $display("Scenario 2: PAU Primary + Aux Legal Dual-Write [STARTING]");
    pau_req            = 1'b1;
    pau_wr_en          = 4'b1111;
    ...
    // ------------------------------------------------------------------
    $display("Scenario 3: PAU Primary-Read + Aux-Write Overlap [STARTING]");
    pau_req               = 1'b1;
    pau_rd_en             = 1'b1;
    pau_rd_poly_id        = POLY_ID_S2;
    pau_rd_idx[0]         = COEFF_W'(0);
    ...
    // ------------------------------------------------------------------
    $display("Scenario 4: PAU Primary-Read + Aux-Write Conflict (Stall) [STARTING]");
    pau_req               = 1'b1;
    pau_rd_en             = 1'b1;
    pau_rd_poly_id        = POLY_ID_S2;
    pau_rd_idx[0]         = COEFF_W'(0);
    ...
    // ------------------------------------------------------------------
    $display("Scenario 5: PAU + TR Dual-Read Concurrent Issue [STARTING]");
    pau_req           = 1'b1;
    pau_rd_en         = 1'b1;
    pau_rd_poly_id    = POLY_ID_S2;
    pau_rd_idx[0]     = COEFF_W'(0);
    ...
    //    is active.
    // ------------------------------------------------------------------
    $display("Scenario 6: HSU Poly-Read Blocking (Unauthorized) [STARTING]");
    hsu_req           = 1'b1;
    hsu_rd_en         = 1'b1;
    ...
    // ------------------------------------------------------------------
    $display("Scenario 7: HSU Hash-EK T-Slot Authorized Reads [STARTING]");
    ...
    // ------------------------------------------------------------------
    $display("Scenario 8: HSU Hash-EK Range Constraints [STARTING]");
    ...
    // ------------------------------------------------------------------
    $display("Scenario 9: HSU Hash-EK Combined R+W Rejection [STARTING]");
    hsu_hash_ek_read_en = 1'b1;
    hsu_req             = 1'b1;
    hsu_rd_en           = 1'b1;
    ...
    // ------------------------------------------------------------------
    $display("Scenario 10: PAU + HSU Hash-EK Dual-Read Issue [STARTING]");
    pau_req           = 1'b1;
    pau_rd_en         = 1'b1;
    pau_rd_poly_id    = POLY_ID_S2;
    pau_rd_idx[0]     = COEFF_W'(0);
    ...
    // ------------------------------------------------------------------
    $display("Scenario 11: PAU Read + HSU Write Overlap Issue [STARTING]");
    pau_req           = 1'b1;
    pau_rd_en         = 1'b1;
    pau_rd_poly_id    = POLY_ID_S2;
    pau_rd_idx[0]     = COEFF_W'(0);
    ...
    // ------------------------------------------------------------------
    $display("Scenario 12: PAU + HSU Dual-Write Issue [STARTING]");
    pau_req        = 1'b1;
    pau_wr_en      = 4'b1111;
    ...
    // ------------------------------------------------------------------
    $display("Scenario 13: TR Read + HSU Write Overlap Issue [STARTING]");
    tr_req            = 1'b1;
    tr_rd_en          = 1'b1;
    ...
    // ------------------------------------------------------------------
    $display("Scenario 14: PAU Atomic Combined R+W vs HSU [STARTING]");
    pau_req           = 1'b1;
    pau_rd_en         = 1'b1;
    pau_rd_poly_id    = POLY_ID_S2;
    pau_rd_idx[0]     = COEFF_W'(0);
    ...
    // ------------------------------------------------------------------
    $display("Scenario 15: PAU Combined Same-Addr Fault (3'b001) [STARTING]");
    pau_req           = 1'b1;
    pau_rd_en         = 1'b1;
    pau_rd_poly_id    = POLY_ID_S2;
    pau_rd_idx[0]     = COEFF_W'(0);
    ...
    // ------------------------------------------------------------------
    $display("Scenario 16: Semantic S-Slot In-Place Overwrite [STARTING]");
    hsu_req        = 1'b1;
    hsu_wr_en      = 4'b1111;
    ...
    // ------------------------------------------------------------------
    $display("Scenario 17: Semantic E-Slot Overwrite + T-Slot Commit [STARTING]");
    hsu_req        = 1'b1;
    hsu_wr_en      = 4'b1111;
    ...
    // ------------------------------------------------------------------
    $display("Scenario 18: Seed/Protocol Store Dual-Port Concurrent Access [STARTING]");
    hsu_seed_req   = 1'b1;
    hsu_seed_we    = 1'b1;
    ...
    // ------------------------------------------------------------------
    $display("Scenario 19: Inter-Client Collision Scheduler Filtering [STARTING]");
    pau_req           = 1'b1;
    pau_rd_en         = 1'b1;
    pau_rd_poly_id    = POLY_ID_S2;
    pau_rd_idx[0]     = COEFF_W'(0);
    ...
    // ------------------------------------------------------------------
    $display("Scenario 20: Security Wipe Blocking & Clearance [STARTING]");
    wipe_i = 1'b1;
    tick();
    wipe_i = 1'b0;
    ...
    // ------------------------------------------------------------------
    $display("Scenario 21: Intra-Request Bank Collision (Skewed mapping: 0, 85) [STARTING]");
    pau_req           = 1'b1;
    pau_rd_en         = 1'b1;
    ...
    $display("=================================================================================");
    $display("ALL MEM_FRONTEND_TOP_TB TESTCASES PASSED");
    $display("=================================================================================");
    $finish;
  end
